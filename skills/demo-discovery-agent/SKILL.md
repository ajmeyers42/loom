---
name: demo-discovery-agent
description: >
  Lightweight AE/SDR entry point for the demobuilder pipeline. Runs discovery parsing,
...
to open the full `demobuilder` orchestrator instead. Your job ends with `demo-goals.md`.
...
Read `skills/demo-discovery-parser/SKILL.md` and execute it fully.
...
or individual JSON exports), read `skills/demo-diagnostic-analyzer/SKILL.md` and
execute it.
...
Read `skills/demo-opportunity-review/SKILL.md` and execute it fully.
...
**Suggested archetype:** {Name from the Demo Archetype Gallery in demo-ideation/SKILL.md}
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
SA next step: Open demobuilder with opportunity/{slug}-demo-goals.md
