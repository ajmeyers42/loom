...
**Loaded by:** `skills/demo-deploy/SKILL.md`, `skills/demo-data-modeler/SKILL.md`, `skills/demo-ml-designer/SKILL.md`
...
`demo-ml-designer/SKILL.md` and older `mapping-patterns.md` examples may reference the local ECH model path `".elser_model_2_linux-x86_64"`. This is a pre-EIS pattern. Use `".elser-2"` for ECH and `service: "elser"` for Serverless as documented above.
