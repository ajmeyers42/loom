...
**Loaded by:** `skills/demo-deploy/SKILL.md`, `skills/demo-platform-audit/SKILL.md`, `skills/demo-kibana-agent-design/SKILL.md`, `skills/demo-fleet-integrations/SKILL.md`, `skills/demo-data-modeler/SKILL.md`
