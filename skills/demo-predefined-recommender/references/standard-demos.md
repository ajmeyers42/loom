...
This file is the lookup table used by `demo-predefined-recommender` to evaluate whether
...
`demo-predefined-recommender` reads this file in Step 1 and maps each entry against the
