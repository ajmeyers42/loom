---
name: demo-predefined-recommender
description: >
  ...
  and hands off to demo-script-template. Customers are never told whether the demo is custom
...
If no, you flag the engagement as custom and hand off to `demo-script-template`.
...
|---|---|---|
| `demo/{slug}-ideation.md` | demo-ideation | **Required** — frozen SA direction |
| `opportunity/{slug}-opportunity-profile.json` | demo-opportunity-review | Required |
| `demo/{slug}-platform-audit.json` | demo-platform-audit | Required |
| `skills/demo-predefined-recommender/references/standard-demos.md` | this skill | Required — lookup table |

If `demo/{slug}-ideation.md` is missing, stop and tell the SA to run `demo-ideation` first.
...
→ Present the decision to the SA and proceed to `demo-script-template`.
...
using technical-win framing. See `demo-ideation` Step: Post-Ideation Refresh for the
...
Proceeding to demo-script-template.
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```

Hand off to `demo-script-template`. Pass `demo/{slug}-ideation.md` as the primary input —
