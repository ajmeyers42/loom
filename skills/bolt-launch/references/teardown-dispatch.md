...
**Loaded by:** `skills/wind-reset/SKILL.md`
...
2. Delete the **cluster manifest document** from `loom-manifests/{engagement_id}`
...
- **Never delete** `.kibana*`, `.fleet*`, `.security*`, `loom-manifests`, or any system index
