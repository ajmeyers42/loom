# Demo2Win Conventions — demobuilder Script Standard

**Source:** [2Win! Global — Demo2Win® methodology](https://www.2winglobal.com/programs/demo2win/)
**Scope:** These are the structural rules `demo-script-template` enforces for all custom demos.
...
## Mapping to the `demo-script-template` Scene Structure
...
The three rules above are the minimum required by demobuilder. The full methodology
